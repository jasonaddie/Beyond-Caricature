...
Dragonfly.app(:ckeditor).configure do
  ...
  url_format "/media/editor_uploads/:job/:name"

  if Rails.env.development?
    datastore :file,
      root_path: Rails.root.join('public/system/dragonfly/editor_uploads', Rails.env),
    ...
    datastore :s3,
      ...
      root_path: Rails.application.credentials.dig(:aws, :root_path_ckeditor),
      fog_storage_options: {
